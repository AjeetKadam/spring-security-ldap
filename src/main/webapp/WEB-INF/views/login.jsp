...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
		...
		<form action="<%=request.getContextPath()%>/j_spring_security_check" method="post" class="form-signin">
		  	<h1>Login</h1>
			...
			<label class="checkbox">
				<input type="checkbox" value="remember-me" id="j_remember_me" name="j_remember_me"> Remember me
			</label>
